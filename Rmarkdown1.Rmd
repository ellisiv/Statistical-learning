...
**Q14:**
We produce an ROC, Receiver Operating Characteristics, curve by comparing the specificity of the classifier to the sensitivity.  
...
M_auc = auc(M_roc)
ggroc(M_roc) + ggtitle("ROC")
cat("The AUC is: ", M_auc)
```
